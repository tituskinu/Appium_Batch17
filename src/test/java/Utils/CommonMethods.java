...
public class CommonMethods extends PageInitializer {
    ...
    public static void launchingTheApplication() throws MalformedURLException {
        utils.CofigReader.readProperties();
        ...
        capabilities.setCapability("appPackage", utils.CofigReader.getPropertyValue("appPackage"));
        capabilities.setCapability("appActivity", utils.CofigReader.getPropertyValue("appActivity"));
